...
export const SITE_COPY_DEFINITIONS: SiteCopyDefinition[] = [
  ...
  },
  {
    ...
    defaultValue:
      "Когда доход нестабилен, легко потерять ощущение контроля. ФинПилот — AI-помощник для личных финансов: помогает понять, что уходит на расходы и долги, какие платежи давят сильнее всего и с чего начать, чтобы навести порядок в деньгах.",
  },
  {
