...
export const HINTS = {
  ...
  incomeMonth:
    "Для самозанятых доход может быть нестабильным: FinPilot сравнивает фактические поступления с ожидаемым доходом и средним за прошлые месяцы. В расходах учитываются регулярные платежи и разовые операции текущего месяца.",
} as const;
