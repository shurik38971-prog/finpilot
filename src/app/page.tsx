...
export const metadata: Metadata = {
  ...
  title: "ФинПилот — AI-помощник для личных финансов",
  description:
    "Порядок в личных финансах: доходы, расходы и долги, платежи, финансовый план на 30 дней. Подходит и при нестабильном доходе.",
  keywords: [
    "личные финансы",
    "расходы и долги",
    "платежи",
